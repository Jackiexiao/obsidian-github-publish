...
## TL'DR 太长不看版
> 2023-07-27 更新，我现在基本用 openai azure api 了，不过国内现在也有很多大模型出来，效果也不错

- 愿意给各种套壳应用付款的用户，不用往下看了，推荐 [[我日常使用频率最高的chatgpt应用]]
- 小白用户
    - 白嫖用户点击: [[#如何免费白嫖]]
    - 愿意付费用户点击 : [[#付费网站推荐]]
- 愿意花点时间折腾的性价比用户点击 [[#如何获取apikey]]
- 高阶: 能翻墙，能注册海外信用卡用户: 你不用我教 哈哈哈哈哈
...
- 如果你有魔法能力: 到[官网](https://platform.openai.com/account/api-keys)注册账户获取apikey
